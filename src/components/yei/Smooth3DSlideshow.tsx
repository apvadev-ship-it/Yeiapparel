...
export interface Smooth3DSlideshowProps {
  ...
  showTitle?: boolean;
  titleFont?: CSSProperties | Record<string, unknown>;
  titleColor?: string;
  titlePosition?: {
...
function cssTransition(t: Record<string, unknown> | undefined): {
  dur: number;
  ease: string;
} {
      ...
      >
        {list.map((slide, i) => {
          ...
          const cardStyle: CSSProperties = {
            ...
            opacity: visible ? 1 : 0,
            cursor: autoplay || isActive ? "pointer" : "pointer",
          ...
          return (
            <div
              ...
              style={cardStyle}
              onClick={
                isStatic ? undefined : () => handleCardClick(i, slide.url)
              }
