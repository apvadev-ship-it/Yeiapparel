                  ...
                  <div className="notch-frame bg-chocolate/20 p-[2px] shadow-2xl">
                    ...
                    >
                      ...
                      <div className="absolute top-5 left-5 right-5 flex items-center justify-between z-10">
                        <span className="notch-frame-sm bg-chocolate/85 backdrop-blur-md px-3.5 py-1.5 text-[11px] font-mono tracking-widest text-marfil border border-terracota/40 flex items-center gap-2">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center z-10">
                        ...
                        >
                          ...
                          <div className="relative grid h-20 w-20 sm:h-24 sm:w-24 place-items-center rounded-full bg-terracota text-marfil shadow-2xl border-2 border-terracota/70">
        ...
        <>
          ...
          <div className="fixed inset-0 z-[90] flex items-center justify-center p-4 sm:p-6 pointer-events-none">
            <motion.div
              ...
              className="pointer-events-auto relative w-full max-w-md overflow-hidden notch-frame bg-chocolate text-marfil shadow-2xl border border-terracota/40"
            >
